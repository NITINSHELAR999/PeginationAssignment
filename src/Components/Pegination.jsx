  ...
  return (
    <div className="container">
        <div className="button_holder my-4">
            <div>
                <button className="red" onClick={() => {listView()} }>List View</button>
            </div>
            <div>
            <button className="red" onClick={() => {gridView()}}>Grid View</button>
            </div>
        </div>
      <div className="row p-2">
        ...
        paginated.map((ele, i) => {
          return (
            <div className="col-md-4 col-sm-4 col-xs-12 card m-2" id="col" key={i}>
          ...
          return (
            <div className="card m-2" id="col" key={i}>
              <div className="card-body">
                <h5 className="card-title">{ele.id}. {ele.title}</h5>
                <p className="card-text">{ele.body}</p>
              </div>
